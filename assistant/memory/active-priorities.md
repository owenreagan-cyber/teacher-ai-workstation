...
- Classroom App Lab — Prototype Rescue: future capability queued (`docs/long-term-future-programs-roadmap.md`). Documentation/status only — no zip extraction, code parsing, app execution, or LLM/API analysis.
