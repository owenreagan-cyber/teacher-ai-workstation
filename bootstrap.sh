...
log "We will check your Mac, install tools, apply helpful settings, create folders, and run automated setup verification."
log "A full log will be saved to ${LOG_FILE}."
log "Note: automated verification checks scriptable setup items only. Manual Day 1 certification happens after bootstrap."
...
log ""
log "🎉 Phase 0 automated setup is complete."
log "The automated verification has run."
log "Next: complete the manual checklist in docs/day-1-manual-steps.md."
log "After manual setup, restart the Mac once, then rerun:"
log "bash setup/99-verify-setup.sh"
