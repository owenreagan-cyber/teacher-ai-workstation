# Code Cracker — Runtime Implementation Packet
...
- Planning doc: `docs/classroom-utilities/code-cracker-planning.md`
- Fixture: `assistant/classroom-utilities/samples/code-cracker-planning/example-settings-001.json`
...
> "I approve runtime implementation for Code Cracker local-only prototype per the implementation packet and runtime approval gate."
