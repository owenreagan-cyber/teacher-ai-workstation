# iPad Optimizer Prompt Generator — Runtime Implementation Packet
...
- Planning doc: `docs/classroom-utilities/ipad-optimizer-prompt-engine-planning.md`
- Fixture: `assistant/classroom-utilities/samples/ipad-optimizer-prompt-engine-planning/example-settings-001.json`
...
> "I approve runtime implementation for iPad Optimizer Prompt Generator local-only prototype per the implementation packet and runtime approval gate."
