# Live Session Auto-Burst Presentation Engine — Runtime Implementation Packet
...
- Planning doc: `docs/classroom-utilities/live-session-auto-burst-presentation-planning.md`
- Fixture: `assistant/classroom-utilities/samples/live-session-auto-burst-presentation-planning/example-settings-001.json`
...
> "I approve runtime implementation for Live Session Auto-Burst Presentation Engine local-only prototype per the implementation packet and runtime approval gate."
