# Shurley English Chapter Parser — Runtime Implementation Packet
...
- Planning doc: `docs/classroom-utilities/shurley-chapter-parser-planning.md`
- Fixture: `assistant/classroom-utilities/samples/shurley-chapter-parser-planning/example-settings-001.json`
...
> "I approve runtime implementation for Shurley English Chapter Parser local-only prototype per the implementation packet and runtime approval gate."
