# Thales OS Morning Preview Banner — Runtime Implementation Packet
...
- Planning doc: `docs/classroom-utilities/thales-os-morning-preview-banner-planning.md`
- Fixture: `assistant/classroom-utilities/samples/thales-os-morning-preview-banner-planning/example-settings-001.json`
...
> "I approve runtime implementation for Thales OS Morning Preview Banner local-only prototype per the implementation packet and runtime approval gate."
