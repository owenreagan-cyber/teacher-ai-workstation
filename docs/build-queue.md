...
- Instructional Artifact Quality System Phase 2 visual geometry (2026-07-28): `scripts/artifact_quality/visual_geometry.py`; rendered-page metrics (text/drawing/visible-ink coverage, writing-space estimate, bottom whitespace, page balance, safe margins); annotated previews; contact sheets; visual student/key comparison; `--annotate`, `--contact-sheet`, `--visual-compare`, `--analysis-dpi`; `tests/artifact_quality/test_visual_geometry.py`; no network, Canvas, student data, or automatic print deployment.
