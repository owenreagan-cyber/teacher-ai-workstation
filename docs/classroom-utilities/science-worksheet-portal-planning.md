# Science Worksheet Portal — Planning Lane

Last updated: 2026-07-04

```text
Status: planning-only — not implementation approval
Closure: complete_science_worksheet_portal_planning_lane
Classification: Tier 3 app planning lane
Inventory row: 51
Category: curriculum prep
...
Plan science worksheet portal wireframe — fake topic labels only.
...
• Unit topic placeholders
• Worksheet shell labels
• No real science content

## Fake / Local Examples

See `assistant/classroom-utilities/samples/science-worksheet-portal-planning/`. Fixtures are `fake_local_planning_only`.

Primary fixture label: `example-science-topic-label`

## Text-Only Wireframe (Concept)

```text
+------------------------------------------+
|  Science Worksheet Portal          [ mode selector ]       |
|                                          |
...
`complete_science_worksheet_portal_planning_lane` is documentation only. No runtime authorized.
