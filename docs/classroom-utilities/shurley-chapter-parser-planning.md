# Shurley English Chapter Parser — Planning Lane

Last updated: 2026-07-04

```text
Status: planning-only — not implementation approval
Closure: complete_shurley_chapter_parser_planning_lane
...
Plan chapter outline labels — no parser, no real Shurley content.
...
See `assistant/classroom-utilities/samples/shurley-chapter-parser-planning/`. Fixtures are `fake_local_planning_only`.

Primary fixture label: `example-chapter-outline-label`

## Text-Only Wireframe (Concept)

```text
+------------------------------------------+
|  Shurley English Chapter Parser          [ mode selector ]       |
|                                          |
...
`complete_shurley_chapter_parser_planning_lane` is documentation only. No runtime authorized.
