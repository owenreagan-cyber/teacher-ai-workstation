# Shurley Sentence Diagrammer — Planning Lane
...
Plan sentence diagram wireframe labels — fake sentences only.
...
• Sentence placeholder labels
• Diagram node text
• No real curriculum sentences

## Fake / Local Examples

See `assistant/classroom-utilities/samples/shurley-sentence-diagrammer-planning/`. Fixtures are `fake_local_planning_only`.

Primary fixture label: `example-sentence-diagram-label`

## Text-Only Wireframe (Concept)

```text
+------------------------------------------+
|  Shurley Sentence Diagrammer          [ mode selector ]       |
|                                          |
...
`complete_shurley_sentence_diagrammer_planning_lane` is documentation only. No runtime authorized.
