# Spelling Studio — Planning Lane

Last updated: 2026-07-04

```text
Status: planning-only — not implementation approval
Closure: complete_spelling_studio_planning_lane
...
Plan literacy practice shell labels — fake word lists only; curriculum gate applies.
...
• Fake word-list labels
• Practice mode placeholders
• Real curriculum ingestion blocked

## Fake / Local Examples

See `assistant/classroom-utilities/samples/spelling-studio-planning/`. Fixtures are `fake_local_planning_only`.

Primary fixture label: `example-spelling-word-label`

## Text-Only Wireframe (Concept)

```text
+------------------------------------------+
|  Spelling Studio          [ mode selector ]       |
|                                          |
...
`complete_spelling_studio_planning_lane` is documentation only. No runtime authorized.
