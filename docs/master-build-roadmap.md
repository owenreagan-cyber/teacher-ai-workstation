...
Production registry workflow **planning brief** is complete (`docs/curriculum-builder-production-registry-workflow-planning-brief.md`; `--curriculum-production-registry-planning-status`). Owen recorded governance affirmations 2026-07-02 (items 5, 6, 7, 8, 9, 11 approved; items 1, 2, 3, 4, 10 deferred) — use `docs/curriculum-builder-production-registry-owen-review-packet.md` and `docs/curriculum-builder-production-registry-owen-decision-worksheet.md` (post-decision routing: `docs/curriculum-builder-production-registry-post-decision-implementation-map.md`). **Next decision step: path + namespace (items 1 and 10).** Write behavior (item 2) remains deferred. No implementation mission should start until path, namespace, and write behavior are explicitly approved. Metadata pilot planning is documented (`docs/curriculum-builder-metadata-pilot-planning-boundary.md`; `docs/curriculum-builder-manual-metadata-boundary.md`) — intake remains blocked. Production writes, real metadata intake, and integrations remain blocked.
