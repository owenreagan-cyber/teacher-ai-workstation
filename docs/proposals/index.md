...
| Teacher Knowledge Vault M7f persistent local working catalog approval gate | Chief of Staff / Memory | 2 | medium | low | low | none | none | none | implemented | complete — approval gate only; M7g persistent catalog runtime blocked | Knowledge Vault M7f Persistent Catalog Gate 2026-07-05 | 2026-07-05 |
| Teacher Knowledge Vault M2c selected local folder metadata scan approval gate | Chief of Staff / Memory | 2 | medium | low | low | none | none | none | implemented | complete — approval gate only; M2d fixed-path scan in separate milestone | Knowledge Vault M2c Selected Folder Gate 2026-07-05 | 2026-07-05 |
| Teacher Knowledge Vault M2d first selected folder metadata scan | Chief of Staff / Memory | 2 | medium | low | low | none | none | none | implemented | complete — fixed Owen-approved tiny test folder only; metadata-only; M7g preview only | Knowledge Vault M2d Metadata Scan 2026-07-05 | 2026-07-05 |
| Teacher Knowledge Vault M2b repo-owned staging metadata prototype | Chief of Staff / Memory | 2 | medium | low | low | none | none | none | implemented | complete — repo-owned fixture staging metadata only; real selected-folder scan blocked | Knowledge Vault M2b Staging Metadata 2026-07-05 | 2026-07-05 |
| Teacher Knowledge Vault M7e local test catalog import | Chief of Staff / Memory | 2 | medium | low | low | none | none | none | implemented | complete — disposable test catalog from fixtures only; M7g persistent catalog runtime blocked | Knowledge Vault M7e Test Catalog 2026-07-04 | 2026-07-04 |
...
| AGENTS.md governance rules | Cursor / Governance | 1 | medium | low | low | none | none | none | implemented | complete — `AGENTS.md`; `--agents-governance-status`; global guidance only | AGENTS.md Governance 2026-07-10 | 2026-07-10 |
