...
| Gemini discovery/classification architecture intake | Cursor / Governance | 2 | medium | low | low | none | none | none | implemented | complete — `docs/proposals/ideas/gemini-discovery-classification-architecture-intake.md`; `--gemini-discovery-classification-intake-status` | Gemini Discovery Classification Intake 2026-07-03 | 2026-07-03 |
