...
| Teacher Knowledge Vault M2c selected local folder metadata scan approval gate | Chief of Staff / Memory | 2 | medium | low | low | none | none | none | implemented | complete — approval gate only; M2d real selected-folder scan blocked | Knowledge Vault M2c Selected Folder Gate 2026-07-05 | 2026-07-05 |
