...
| Production registry metadata boundary refinement | implemented read-only | `--curriculum-production-registry-metadata-boundary-status`; field contracts and guardrails; no mutation |
