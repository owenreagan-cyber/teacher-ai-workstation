...
| Owen § J production registry checklist tracker | implemented read-only | `--curriculum-production-registry-owen-checklist-status`; 9 approved + 2 deferred (2026-07-02); item 2 in principle |
