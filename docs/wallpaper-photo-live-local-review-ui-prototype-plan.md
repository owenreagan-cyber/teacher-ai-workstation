...
Phase O defines live local review UI prototype planning. Phase P defines image processor foundation with output intents and sample processing plan validation. Phase Q defines scheduler foundation with run intents and preflight checks. Phase R defines notification foundation with review-ready summary fields and dry-run notification previews. See `docs/wallpaper-photo-image-processor-foundation.md`, `docs/wallpaper-photo-scheduler-foundation.md`, and `docs/wallpaper-photo-notification-foundation.md`.
