...
check_file docs/cursor-autonomous-build-engine-level-2-batch-playbook.md
...
check_doc_contains docs/cursor-autonomous-build-engine-level-2-batch-playbook.md "planning-only" "abe level 2 batch playbook"
