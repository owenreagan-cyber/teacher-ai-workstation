...
EXPECTED_MARKDOWN_FILES = {
    ...
    "teacher-decision-contract.md",
    "canvas-deployment-readiness-contract.md",
    "canvas-connector-contract.md",
    "write-gate-contract.md",
    "deployment-audit-contract.md",
    "together-logic.md",
