...
check_contains "${AGENT}" '"inventory"' "agent supports inventory mode"
check_contains "${AGENT}" '"reference-inventory"' "agent supports reference-inventory mode"
check_contains "${AGENT}" '"questions"' "agent supports questions mode"
check_contains "${AGENT}" '"experiment"' "agent supports experiment mode"
check_contains "${AGENT}" '"existing-page-dry-run"' "agent supports existing-page-dry-run mode"
check_contains "${AGENT}" '"cleanup"' "agent supports cleanup mode"
