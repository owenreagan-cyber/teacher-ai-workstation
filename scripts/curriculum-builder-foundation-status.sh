...
section "Review Game Contract v0 Foundation Checks"

check_file "${review_game_v0_doc}"
check_file "assistant/curriculum-builder/output-contract/v0/review-game-contract-schema.json"
check_file "assistant/curriculum-builder/output-contract/v0/contracts/sample-review-game-001.json"
check_doc_contains "${review_game_v0_doc}" "review_game_contract" "review game v0 contract type documented"
check_doc_contains "${review_game_v0_doc}" "round_placeholders" "review game v0 round_placeholders documented"
check_doc_contains "${review_game_v0_doc}" "no lesson generation" "review game v0 no lesson generation boundary"
check_doc_contains "${review_game_v0_doc}" "no renderers" "review game v0 no renderers boundary"
check_doc_contains "${review_game_v0_doc}" "no student data" "review game v0 no student data boundary"
check_doc_contains "${output_contract_v0_doc}" "review_game_contract" "output contract v0 documents review game canonical"
check_doc_contains "${section_completion_audit_doc}" "Review Game Contract Schema v0" "section completion audit references review game v0"
check_doc_contains "${build_queue_doc}" "Review Game Contract" "build queue references review game v0"
check_doc_contains "${active_priorities_doc}" "Review Game Contract" "active priorities references review game v0"

section "Canvas Package Contract v0 Foundation Checks"

check_file "${canvas_package_v0_doc}"
check_file "assistant/curriculum-builder/output-contract/v0/canvas-export-package-contract-schema.json"
check_file "assistant/curriculum-builder/output-contract/v0/contracts/sample-canvas-package-001.json"
check_doc_contains "${canvas_package_v0_doc}" "canvas_export_package_contract" "canvas package v0 contract type documented"
check_doc_contains "${canvas_package_v0_doc}" "module_placeholders" "canvas package v0 module_placeholders documented"
check_doc_contains "${canvas_package_v0_doc}" "no lesson generation" "canvas package v0 no lesson generation boundary"
check_doc_contains "${canvas_package_v0_doc}" "no renderers" "canvas package v0 no renderers boundary"
check_doc_contains "${canvas_package_v0_doc}" "no student data" "canvas package v0 no student data boundary"
check_doc_contains "${canvas_package_v0_doc}" "no_canvas_api" "canvas package v0 no canvas api boundary"
check_doc_contains "${output_contract_v0_doc}" "canvas_export_package_contract" "output contract v0 documents canvas package canonical"
check_doc_contains "${section_completion_audit_doc}" "Canvas Export Package Contract Schema v0" "section completion audit references canvas package v0"
check_doc_contains "${build_queue_doc}" "Canvas Package Contract" "build queue references canvas package v0"
check_doc_contains "${active_priorities_doc}" "Canvas Package Contract" "active priorities references canvas package v0"
