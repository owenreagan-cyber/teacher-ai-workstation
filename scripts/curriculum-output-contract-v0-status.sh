...
check_file "${contract_root}/placeholders/worksheet-contract-placeholder.json"
check_file "${contract_root}/placeholders/review-game-contract-placeholder.json"
check_file "${contract_root}/placeholders/teacher-script-contract-placeholder.json"
