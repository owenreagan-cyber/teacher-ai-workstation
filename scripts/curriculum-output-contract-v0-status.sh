...
review_game_doc="docs/curriculum-review-game-contract-v0.md"
canvas_package_doc="docs/curriculum-canvas-package-contract-v0.md"
...
check_file "${contract_root}/review-game-contract-schema.json"
check_file "${contract_root}/canvas-export-package-contract-schema.json"
...
check_file "${contract_root}/contracts/sample-review-game-001.json"
check_file "${contract_root}/contracts/sample-canvas-package-001.json"
...
check_doc_contains "${contract_doc}" "review_game_contract"
check_doc_contains "${review_game_doc}" "review_game_contract"
check_doc_contains "${review_game_doc}" "no lesson generation"
check_doc_contains "${contract_doc}" "canvas_export_package_contract"
check_doc_contains "${canvas_package_doc}" "canvas_export_package_contract"
check_doc_contains "${canvas_package_doc}" "no lesson generation"
check_doc_contains "${canvas_package_doc}" "no_canvas_api"
