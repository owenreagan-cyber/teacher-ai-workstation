...
check_doc_contains "${agents_md}" "docs/teacher-workstation-capability-map.md" "AGENTS.md links capability map"
check_doc_contains "${agents_md}" "docs/owen-architecture-decision-packets.md" "AGENTS.md links decision packets"
check_doc_contains "${proposals_index}" "AGENTS.md" "proposals index links AGENTS.md"
