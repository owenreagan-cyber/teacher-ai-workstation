...
proposals_index_doc="docs/proposals/index.md"
agents_md="AGENTS.md"
...
check_file "${proposals_index_doc}"
check_text "${agents_md}" "does not replace" "AGENTS.md states non-replacement of authority docs"
check_text "${agents_md}" "docs/engineering-constitution.md" "AGENTS.md links engineering constitution"
check_text "${agents_md}" "docs/implementation-approval-gate.md" "AGENTS.md links implementation gate"
check_text "${agents_md}" "Permanent Hard Boundaries" "AGENTS.md defines hard boundaries"
check_text "${agents_md}" "Escalation Conditions" "AGENTS.md defines escalation conditions"
check_text "${agents_md}" "Non-Activation Confirmation" "AGENTS.md includes non-activation confirmation"
check_text "${agents_md}" "Canonical Reference Map" "AGENTS.md defines canonical reference map"
check_text "${agents_md}" "docs/whole-system-master-roadmap-build-state-report.md" "AGENTS.md links whole-system build-state report"
check_text "${agents_md}" "docs/agent-builder-compatibility-and-external-tool-governance.md" "AGENTS.md links agent builder governance"
check_text "${agents_md}" "scripts/chief-of-staff-validate-all.sh" "AGENTS.md links validate-all script"
check_text "${agents_md}" "docs/chief-of-staff-command-index-v1.md" "AGENTS.md links command index"
check_text "${build_queue_doc}" "AGENTS.md" "build queue links AGENTS.md"
check_text "${master_build_roadmap_doc}" "AGENTS.md" "master roadmap links AGENTS.md"
check_text "${active_priorities_doc}" "AGENTS.md" "active priorities links AGENTS.md"
check_text "${operating_modes_doc}" "Maximum Autonomous Execution Mode" "operating modes doc defines autonomous execution"
check_text "${operating_modes_doc}" "Proposal Lifecycle" "operating modes doc defines proposal lifecycle"
check_text "${domain_boundaries_doc}" "Parent Communication Agents" "domain boundaries doc defines parent communication"
check_text "${proposals_index_doc}" "Proposal Ledger" "proposals index defines ledger"
...
check_text "${build_queue_doc}" "3D Builder" "build queue references 3d builder"
