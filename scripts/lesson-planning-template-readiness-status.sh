...
if [[ -f "${readiness_doc}" ]]; then
  ...
  check_doc_contains "${readiness_doc}" "Lesson-Planning Placeholder Readiness Closeout" "Lesson-Planning Placeholder Readiness Closeout"
  check_doc_contains "${readiness_doc}" "assistant/lesson-planning/templates/lesson-planning-placeholder-skeleton.md" "placeholder skeleton path in closeout"
  check_doc_contains "${readiness_doc}" "assistant/lesson-planning/templates/placeholder-template-registry.md" "placeholder template registry path in closeout"
  check_doc_contains "${readiness_doc}" "static template schema planning is planning-only" "static template schema planning is planning-only"
  check_doc_contains "${readiness_doc}" "no schema file or validator is active" "no schema file or validator is active"
  check_doc_contains "${readiness_doc}" "no lesson generation, lesson briefs, lesson drafts, or review notes are active" "no lesson generation, lesson briefs, lesson drafts, or review notes are active"
  check_doc_contains "${readiness_doc}" "follow-ons require documentation/status-only approval" "follow-ons require documentation/status-only approval"
  check_doc_contains "${readiness_doc}" "Lesson-planning placeholder readiness closeout complete" "lesson-planning placeholder readiness closeout complete posture"
