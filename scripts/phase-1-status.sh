...
check_doc_contains docs/curriculum-builder-production-registry-owen-checklist-tracker.md "metadata_boundaries_approved_awaiting_pilot_and_write_missions" "owen checklist tracker closure"
check_doc_contains docs/curriculum-builder-production-registry-metadata-source-boundaries.md "metadata_boundaries_approved" "metadata source boundary doc"
