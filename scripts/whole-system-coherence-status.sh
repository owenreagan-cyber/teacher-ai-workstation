...
for closure in \
  ...
  complete_teacher_knowledge_vault_m7b_manual_source_inventory_level_1; do
...
check_doc_contains "${whole_system_report}" "151 / 0 / 0 PASS" "dashboard count current"
check_doc_contains "${whole_system_report}" "70 / 0 / 0 PASS" "validate-all count current"
