...
for closure in \
  ...
  complete_teacher_knowledge_vault_m7c_manual_inventory_import_preview; do
...
check_doc_contains "${whole_system_report}" "152 / 0 / 0 PASS" "dashboard count current"
check_doc_contains "${whole_system_report}" "71 / 0 / 0 PASS" "validate-all count current"
