...
for closure in \
  ...
  complete_teacher_knowledge_vault_m7f_persistent_working_catalog_approval_gate; do
...
check_doc_contains "${whole_system_report}" "155 / 0 / 0 PASS" "dashboard count current"
check_doc_contains "${whole_system_report}" "74 / 0 / 0 PASS" "validate-all count current"
