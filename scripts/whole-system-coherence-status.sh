...
for closure in \
  ...
  complete_teacher_knowledge_vault_m2c_selected_local_folder_approval_gate; do
...
check_doc_contains "${whole_system_report}" "158 / 0 / 0 PASS" "dashboard count current"
check_doc_contains "${whole_system_report}" "77 / 0 / 0 PASS" "validate-all count current"
